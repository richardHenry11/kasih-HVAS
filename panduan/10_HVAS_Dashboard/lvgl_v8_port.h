...
#define LVGL_PORT_TASK_STACK_SIZE               (12 * 1024) // The stack size of the LVGL timer task, in bytes (bumped from 6K: deeply nested flex containers on these screens were close to the old limit)
